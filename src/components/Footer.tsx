...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: Mail, href: "mailto:keerthanagogineni1999@gmail.com", label: "Email" },
  ];
      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-2xl font-poppins text-gradient">Keerthana Gogineni</h3>
            <p className="text-sm text-muted-foreground">
              Full Stack Developer crafting scalable, secure web solutions
            </p>
          </motion.div>
        ...
        >
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Keerthana Gogineni. All rights reserved.
          </p>
